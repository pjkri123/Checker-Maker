...
<body>
    ...
    <h3><spring:message code="userForm.title2" text="Update Customer"/></h3>

    <form:form action="updateSuccess" modelAttribute="customer" method="POST">
        <table>
            <tr>
        ...
        <p>
            <input type="submit" value="<spring:message code="userForm.update" text="update"/>"/>
